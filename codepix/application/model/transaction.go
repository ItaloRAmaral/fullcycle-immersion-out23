...
/*
	Depois do dado de entrada validado, é preciso parsear o json recebido pelo kafka para a struct Transaction.
*/
...
/*
	Depois de processar a transação, é preciso transformar a struct Transaction em um json para enviar para o kafka.
*/
